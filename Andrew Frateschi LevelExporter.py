...
def print_heir(ob, levels=10):
    def recurse(ob, parent, depth):
        ...
        if 'Point' in ob.name:
            file.write(spaces + "Constant:" + "\n")
            file.write(spaces + str(ob.get('My_floats')[0]) + "\n")
            file.write(spaces + "Linear:" + "\n")
            file.write(spaces + str(ob.get('My_floats')[1]) + "\n")
            file.write(spaces + "Quadratic:" + "\n")
            file.write(spaces + str(ob.get('My_floats')[2]) + "\n")
            file.write(spaces + "Ambient:" + "\n")
            file.write(spaces + str(ob.get('My_vectors')[0]) + "\n")
            file.write(spaces + str(ob.get('My_vectors')[1]) + "\n")
            file.write(spaces + str(ob.get('My_vectors')[2]) + "\n")
            file.write(spaces + "Diffuse:" + "\n")
            file.write(spaces + str(ob.get('My_vectors')[3]) + "\n")
            file.write(spaces + str(ob.get('My_vectors')[4]) + "\n")
            file.write(spaces + str(ob.get('My_vectors')[5]) + "\n")
            file.write(spaces + "Specular:" + "\n")
            file.write(spaces + str(ob.get('My_vectors')[6]) + "\n")
            file.write(spaces + str(ob.get('My_vectors')[7]) + "\n")
            file.write(spaces + str(ob.get('My_vectors')[8]) + "\n")
